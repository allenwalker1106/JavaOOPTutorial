...
public class EmployeeModel implements Serializable {
    ...
    public EmployeeModel(String account, String department, String address, LocalDate date, String email, String name, String phoneNumber, String password, String gender) {
