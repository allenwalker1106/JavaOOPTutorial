...
@RequestMapping("/employee_dashboard/car/list/view/delete")
    ...
    public String handleDelete(
        ...
        if(c_carDto.size()!=0){
            ...
            if(o_carService.delete(o_carDto)){
                model.addAttribute("notification","Success Delete Car");
            }else{
                model.addAttribute("notification","Fail To Delete Car");
            }

        }else{
            model.addAttribute("notification","Car Doesn't Exist!");
        }
